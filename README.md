...
First it checks if anything bigger than 0 is in the buffer...  
And if it does, it reads the buffer until it hits a newline charachter "\n" and store it in a string "input"...
Then we use if/else if statements to differ bewteen diffrent input values, in this case "GREEN LED ON" etc...
```
